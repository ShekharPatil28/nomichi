  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 11, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--c-muted)', marginBottom: 4 }}>
          Nomichi
        </p>
        <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--c-earth)', marginBottom: 2 }}>
          Team login
        </h1>
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: 12 }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: 10, fontSize: 13, outline: 'none', color: 'var(--c-text)'
              }}
            />
          </div>
          ...
          <button
            ...
            disabled={loading}
            style={{
              width: '100%', padding: '10px', background: 'var(--c-accent)',
